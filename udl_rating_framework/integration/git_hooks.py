        ...
        try:
            ...
            for file_path in staged_files:
                try:
                    ...
                    with tempfile.NamedTemporaryFile(mode='w', suffix='.udl', delete=False) as tmp:
                        tmp.write(content)
        ...
        try:
            ...
            for line in result.stdout.strip().split('\n'):
                if line:
                    ...
                    if file_path.suffix.lower() in ['.udl', '.dsl', '.grammar', '.ebnf']:
...
def main():
    ...
    parser.add_argument('action', choices=['install', 'uninstall', 'check-staged', 'check-all'])
