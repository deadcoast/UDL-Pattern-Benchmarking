...
class UDLLanguageServer:
    ...
    async def initialize(self, params: Dict[str, Any]) -> Dict[str, Any]:
        ...
        if not text_document_caps.get("publishDiagnostics", {}).get("versionSupport", False):
        ...
        return {
            ...
            "serverInfo": {
                "name": "UDL Rating Language Server",
                "version": "1.0.0"
            }
        }
    ...
    async def text_document_code_action(self, params: Dict[str, Any]) -> List[Dict[str, Any]]:
    ...
    async def text_document_document_symbol(self, params: Dict[str, Any]) -> List[Dict[str, Any]]:
    ...
    def _apply_incremental_change(self, document: TextDocumentItem, change: Dict[str, Any]) -> None:
    ...
    def _extract_document_symbols(self, udl_repr: UDLRepresentation) -> List[Dict[str, Any]]:
    ...
    async def _publish_diagnostics(self, uri: str, diagnostics: List[Diagnostic]) -> None:
        ...
        logger.debug(f"Publishing diagnostics for {uri}: {len(lsp_diagnostics)} diagnostics")
    ...
    async def handle_request(self, request: Dict[str, Any]) -> Optional[Dict[str, Any]]:
        ...
        try:
            if method == "initialize":
                ...
                result = await self.language_server.text_document_document_symbol(params)
                return {"id": request_id, "result": result}
