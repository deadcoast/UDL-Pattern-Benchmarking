...
from udl_rating_framework.core.representation import UDLRepresentation, GrammarRule, TokenType
...
class Grammar:
    ...
    def _analyze_symbols(self):
        ...
        self.terminals = {t for t in self.terminals if t and not self._is_grammar_operator(t)}
    ...
    def _is_regular_grammar(self, grammar: Grammar) -> bool:
        ...
        for rule in grammar.rules:
            ...
            if len(rhs) == 2:
                ...
                if first not in grammar.terminals or second not in grammar.non_terminals:
                    return False
