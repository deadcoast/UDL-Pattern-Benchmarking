...
class RatingPipeline:
    ...
    def compute_rating(self, udl: UDLRepresentation) -> QualityReport:
        ...
        try:
            ...
            if self.enable_tracing:
                step = ComputationStep(
                    ...
                    formula="",
                    inputs={"udl_file": udl.file_path, "metrics": list(self.metric_names)},
            ...
            try:
                ...
                if metric_values:
                    ...
                    confidence = self.confidence_calculator.compute_confidence(prediction_probs)
        ...
        logger.info(f"Overall score: {report.overall_score:.3f}, Confidence: {report.confidence:.3f}")
        
        return report
    
    def compute_batch_ratings(self, udls: List[UDLRepresentation]) -> List[QualityReport]:
        """
        ...
        try:
            ...
            try:
                ...
                results["report_complete"] = (
                    ...
                    hasattr(report, 'confidence') and
                    hasattr(report, 'metric_scores')
                )
            except Exception:
