...
class LRUCache:
    ...
    def put(self, key: str, value: Any, file_hash: Optional[str] = None, 
...
class UDLRepresentationCache:
    ...
    def get_udl(self, file_path: Union[str, Path], content: Optional[str] = None) -> Optional[UDLRepresentation]:
        """
    ...
    def put_udl(self, file_path: Union[str, Path], udl: UDLRepresentation, 
