...
def parse_args():
    ...
    parser.add_argument(
        ...
        action=argparse.BooleanOptionalAction,
        default=False,
        help="Use custom fast sampler to avoid reshuffling.",
    )
    parser.add_argument(
        "--do_compile",
        action=argparse.BooleanOptionalAction,
...
if __name__ == "__main__":
    ...
    train_accuracies_most_certain = (
        [] if args.model in ["ctm", "lstm"] else None
    ...
    if args.reload:
        ...
        if os.path.isfile(chkpt_path):
            ...
            checkpoint = torch.load(
                chkpt_path, map_location=map_location, weights_only=False
            )
