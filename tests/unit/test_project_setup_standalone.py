...
def test_basic_functionality():
    ...
    try:
        ...
        assert confidence < 0.5, f"Uniform distribution should have low confidence, got {confidence}"
        ...
        assert 0.0 <= confidence <= 1.0
        assert confidence > 0.9, f"Delta distribution should have high confidence, got {confidence}"
