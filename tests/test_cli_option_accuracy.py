    ...
    **Validates: Requirements 9.2**
        ...
        **Validates: Requirements 9.2**
        ...
        for option in expected_options:
            assert option in result.output, (
                f"Option '{option}' not found in rate command help"
            )
    ...
    def test_train_command_options_exist(self, runner):
        ...
        **Validates: Requirements 9.2**
        ...
        for option in expected_options:
            assert option in result.output, (
                f"Option '{option}' not found in train command help"
            )
    ...
    def test_compare_command_options_exist(self, runner):
        ...
        **Validates: Requirements 9.2**
        ...
        for option in expected_options:
            assert option in result.output, (
                f"Option '{option}' not found in compare command help"
            )
    ...
    def test_evaluate_command_options_exist(self, runner):
        ...
        **Validates: Requirements 9.2**
        ...
        for option in expected_options:
            assert option in result.output, (
                f"Option '{option}' not found in evaluate command help"
            )
    ...
    def test_global_options_exist(self, runner):
        ...
        **Validates: Requirements 9.2**
        ...
        for option in expected_options:
            assert option in result.output, (
                f"Global option '{option}' not found in help"
            )
    ...
    def test_rate_weight_options_accept_valid_floats(
        self, runner, sample_udl_file, weight
    ):
        """
    ...
    def test_rate_format_option_accepts_valid_choices(
        self, runner, sample_udl_file, temp_dir
    ):
        """
    ...
    def test_rate_format_option_rejects_invalid_choices(self, runner, sample_udl_file):
        ...
        **Validates: Requirements 9.2**
        """
        result = runner.invoke(
            cli, ["rate", str(sample_udl_file), "--format", "invalid_format"]
        )
    ...
    def test_evaluate_k_folds_option_validates_minimum(self, runner, temp_dir):
        ...
        **Validates: Requirements 9.2**
        ...
        result = runner.invoke(
            cli, ["evaluate", str(fake_model), str(temp_dir), "--k-folds", "3"]
        )

        # Should fail with non-zero exit code (error message is logged, not in output)
        assert result.exit_code != 0

    def test_evaluate_bootstrap_samples_option_validates_minimum(
    ...
    def test_train_validation_split_option_validates_range(self, runner, temp_dir):
        ...
        **Validates: Requirements 9.2**
        ...
        result = runner.invoke(
            cli, ["train", str(temp_dir), "--validation-split", "1.5"]
        )
    ...
    def test_train_alpha_beta_sum_validation(self, runner, temp_dir):
        ...
        **Validates: Requirements 9.2**
        ...
        result = runner.invoke(
            cli, ["train", str(temp_dir), "--alpha", "0.8", "--beta", "0.8"]
        )

        assert result.exit_code != 0

    def test_compare_significance_level_option_validates_range(
        self, runner, sample_udl_file, temp_dir
    ):
        """
...
class TestAnalyticsSubcommandOptions:
    ...
    **Validates: Requirements 9.2**
    ...
    def test_timeseries_options_exist(self, runner):
        ...
        for option in expected_options:
            assert option in result.output, (
                f"Option '{option}' not found in timeseries help"
            )
    ...
    def test_portfolio_options_exist(self, runner):
        ...
        for option in expected_options:
            assert option in result.output, (
                f"Option '{option}' not found in portfolio help"
            )
    ...
    def test_predict_options_exist(self, runner):
        ...
        for option in expected_options:
            assert option in result.output, (
                f"Option '{option}' not found in predict help"
            )
    ...
    def test_improve_options_exist(self, runner):
        ...
        for option in expected_options:
            assert option in result.output, (
                f"Option '{option}' not found in improve help"
            )
    ...
    def test_export_options_exist(self, runner):
        ...
        for option in expected_options:
            assert option in result.output, (
                f"Option '{option}' not found in export help"
            )
...
class TestIntegrationSubcommandOptions:
    ...
    **Validates: Requirements 9.2**
    ...
    def test_git_install_hooks_options_exist(self, runner):
        ...
        for option in expected_options:
            assert option in result.output, (
                f"Option '{option}' not found in git install-hooks help"
            )
    ...
    def test_batch_process_options_exist(self, runner):
        ...
        for option in expected_options:
            assert option in result.output, (
                f"Option '{option}' not found in batch-process help"
            )
    ...
    def test_ide_generate_options_exist(self, runner):
        ...
        for option in expected_options:
            assert option in result.output, (
                f"Option '{option}' not found in ide generate help"
            )
