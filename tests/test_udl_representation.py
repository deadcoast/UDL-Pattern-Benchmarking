...
class TestDataClasses:
    ...
    def test_token_creation(self):
        ...
        token = Token(
            text="identifier", type=TokenType.IDENTIFIER, position=10, line=2, column=5
        )
    ...
    def test_grammar_rule_creation(self):
        ...
        constraint = Constraint(
            type="semantic", condition="type_check", metadata={"rule": "type_safety"}
        )
    ...
    def test_constraint_creation(self):
        ...
        constraint = Constraint(type="syntactic", condition="balanced_parens")
        ...
        assert constraint_with_meta.get_metadata_dict() == {
            "priority": 1,
            "scope": "local",
        }
