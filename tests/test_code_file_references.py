        ...
        **Validates: Requirements 4.4**
        ...
        for metric_class in [
            ...
            assert hasattr(metric, "compute"), (
                f"{metric_class.__name__} missing compute method"
            )
            assert hasattr(metric, "get_formula"), (
                f"{metric_class.__name__} missing get_formula method"
            )
            assert hasattr(metric, "get_properties"), (
                f"{metric_class.__name__} missing get_properties method"
            )
        ...
        assert hasattr(calc, "compute_confidence"), (
            "ConfidenceCalculator missing compute_confidence method"
        )
