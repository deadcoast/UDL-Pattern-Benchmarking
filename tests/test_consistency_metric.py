    ...
    def test_consistency_metric_correctness_property(self):
        ...
        **Validates: Requirements 3.2**
        ...
        for num_rules, num_cycles, num_contradictions in test_cases:
            ...
            detected_contradictions = metric.find_contradictions(udl.get_grammar_rules())
            ...
            expected_score = 1.0 - (actual_contradictions + actual_cycles) / (actual_rules + 1)
...
class TestConsistencyMetricUnits:
    ...
    def test_contradiction_detection_method(self):
        ...
        assert len(contradictions) >= 1, f"Expected at least 1 contradiction, found {len(contradictions)}"
    ...
    def test_metric_formula(self):
        ...
        expected_formula = r"Consistency(U) = 1 - \frac{|Contradictions| + |Cycles|}{|Rules| + 1}"
