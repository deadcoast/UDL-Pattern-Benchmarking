...
class TestCompletenessMetric(QualityMetric):
    ...
    def compute(self, udl: UDLRepresentation) -> float:
        ...
        total_meaningful_tokens = len([t for t in tokens if t.type in [
            TokenType.IDENTIFIER, TokenType.OPERATOR, TokenType.LITERAL
        ]])
...
def udl_text_strategy():
    ...
    return st.one_of([
        ...
        st.text(alphabet="abcdefghijklmnopqrstuvwxyz ::=|()'+*0123456789\n# ", min_size=0, max_size=200)
    ])
