...
class TestFastAPIDeployment:
    ...
    def test_metrics_endpoint(self, mock_pipeline):
        ...
        mock_metric.get_formula.return_value = "1 - (|Contradictions| + |Cycles|) / (|Rules| + 1)"
...
class TestDockerConfiguration:
    ...
    def test_dockerfile_exists(self):
        ...
        dockerfile_path = Path(__file__).parent.parent / "deployment" / "docker" / "Dockerfile"
    ...
    def test_docker_compose_exists(self):
        ...
        compose_path = Path(__file__).parent.parent / "deployment" / "docker" / "docker-compose.yml"
...
class TestKubernetesManifests:
    ...
    def test_deployment_manifest_structure(self):
        ...
        deployment_path = Path(__file__).parent.parent / "deployment" / "kubernetes" / "deployment.yaml"
...
class TestDeploymentScripts:
    ...
    def test_scripts_exist_and_executable(self):
        ...
        for script_name in required_scripts:
            ...
            assert file_stat.st_mode & stat.S_IEXEC, f"Script not executable: {script_name}"
    
    def test_build_script_content(self):
        """Test build script has required content."""
        build_script = Path(__file__).parent.parent / "deployment" / "scripts" / "build.sh"
