...
class TestUDLExampleProcessing:
    ...
    **Validates: Requirements 5.1**
    ...
    @pytest.mark.parametrize("udl_filename", [
    ...
    def test_udl_file_processes_through_pipeline(self, examples_dir, core_metrics, udl_filename):
        """
    ...
    def test_all_udl_files_process_without_errors(self, examples_dir, core_metrics):
        ...
        **Validates: Requirements 5.1**
        ...
        assert len(failures) == 0, f"Failed to process {len(failures)} UDL files: {failures}"

    # =========================================================================
    # Additional Grammar Format Tests (Task 26 support)
    # =========================================================================

    @pytest.mark.parametrize("grammar_filename", [
        "simple_antlr.g4",
        "simple_peg.peg",
        "simple_yacc.y",
        "simple_ebnf.ebnf",
    ...
    def test_other_grammar_formats_process(self, examples_dir, core_metrics, grammar_filename):
        """
...
class TestUDLProcessingReport:
    ...
    def test_generate_processing_report(self):
        ...
        core_metrics = ["consistency", "completeness", "expressiveness", "structural_coherence"]
