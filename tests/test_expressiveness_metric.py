...
from udl_rating_framework.core.metrics.expressiveness import ExpressivenessMetric, Grammar
    ...
    def test_expressiveness_metric_correctness_property(self):
        ...
        **Validates: Requirements 3.4**
        ...
        for chomsky_type in [3, 2, 1, 0]:
            ...
            assert classified_type in [0, 1, 2, 3], (
...
class TestExpressivenessMetricUnits:
    ...
    def test_regular_grammar_type_3(self):
        ...
        assert chomsky_type in [2, 3], f"Expected Type-2 or Type-3, got Type-{chomsky_type}"
    ...
    def test_context_free_grammar_type_2(self):
        ...
        assert chomsky_type in [0, 1, 2], f"Expected Type-0, Type-1, or Type-2, got Type-{chomsky_type}"
    ...
    def test_simple_grammar(self):
        ...
        assert 0.0 <= score <= 1.0, f"Simple grammar should have bounded expressiveness, got {score}"
    ...
    def test_complex_grammar(self):
        ...
        assert 0.3 < score <= 1.0, f"Complex grammar should have high expressiveness, got {score}"
    ...
    def test_chomsky_classification_method(self):
        ...
        assert regular_type in [2, 3], f"Regular grammar misclassified as Type-{regular_type}"
        ...
        assert cf_type in [0, 1, 2], f"Context-free grammar misclassified as Type-{cf_type}"
    ...
    def test_kolmogorov_complexity_method(self):
        ...
        assert 0.0 <= simple_complexity <= 1.0, f"Simple complexity {simple_complexity} not bounded"
        ...
        assert 0.0 <= complex_complexity <= 1.0, f"Complex complexity {complex_complexity} not bounded"
        ...
        assert empty_complexity == 0.0, f"Empty text should have 0 complexity, got {empty_complexity}"
    ...
    def test_metric_formula(self):
        ...
        expected_formula = r"Expressiveness(U) = \frac{Chomsky\_Level + Complexity\_Score}{2}"
    ...
    def test_chomsky_levels_mapping(self):
        ...
        for level, score in metric.chomsky_levels.items():
            assert 0.0 <= score <= 1.0, f"Chomsky level {level} maps to invalid score {score}"