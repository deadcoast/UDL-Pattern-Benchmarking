    ...
    for name in all_exports:
        try:
            ...
            if obj is None:
                ...
                errors.append(f"{package_name}.__all__ contains '{name}' but it is None (import failed)")
        except AttributeError:
            errors.append(f"{package_name}.__all__ contains '{name}' but it cannot be accessed")
